@php  $logout_url = View::getSection('logout_url') ?? config('adminlte.logout_url', 'logout') ; @endphp
@php  $profile_url = View::getSection('profile_url') ?? config('adminlte.profile_url', 'logout') ; @endphp
...
@if (config('adminlte.use_route_url', false))
    @php  $profile_url = $profile_url ? route($profile_url) : '' ; @endphp
    @php  $logout_url = $logout_url ? route($logout_url) : '' ; @endphp
@else
    @php  $profile_url = $profile_url ? url($profile_url) : '' ; @endphp
