...
@php $topnavNavClass = trim(config('adminlte.classes_topnav_nav', 'navbar-expand-lg')); @endphp
@php $topnavNavClass = $topnavNavClass === 'navbar-expand' ? 'navbar-expand-lg' : $topnavNavClass; @endphp
