...
@php $rsTitle = config('adminlte.right_sidebar_title'); @endphp
@php $rsLabel = $rsTitle ?: (Lang::has('adminlte::adminlte.toggle_right_sidebar') ? __('adminlte::adminlte.toggle_right_sidebar') : 'Toggle right sidebar'); @endphp
