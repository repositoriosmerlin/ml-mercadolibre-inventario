...
return [
    ...
    */
    ...
    // Auto Animator define la tipografia (Inter + JetBrains Mono, cargadas
    // desde tokens.css), asi que la fuente propia de AdminLTE sobra.
    'google_fonts' => [
        'allowed' => false,
    ],
    ...
    */
    ...
    // El panel es siempre claro: el blanco es el color predominante del
    // sistema de diseno. Con 'remember' en false, AdminLTE desactiva su
    // propio conmutador y deja de seguir la preferencia del sistema
    // operativo, que era lo que estaba pintando el panel en oscuro.
    'color_mode' => [
        'default' => 'light',
        'remember' => false,
